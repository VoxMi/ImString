...
> [!IMPORTANT]
> The current implementation of ImString relies on a specific byte-level union layout for heap/SSO mode detection and exclusively supports Little-Endian platforms. Big-Endian architectures are not currently supported.
